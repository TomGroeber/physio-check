...
> **Stand 27.07.2026 (`main`):** Betreiberportal (`/admin`, strikt getrennte `platform_admin`-Rolle) zum Anlegen/Verwalten von Praxen mit Schritt-für-Schritt-Anleitung, Liquid-Glass-Design für Portal/Praxis-Einstellungen/Nachrichten, native Liquid-Glass-Tab-Leiste in der mobilen App (PR #6 gemergt), vollständige Textnachrichtenfunktion Patient:in ↔ Praxis (vierter Patienten-Navigationspunkt, Web + native App). **In Prüfung (noch nicht gemergt):** Plattformadmin-Zugangs-Wiederherstellung für Praxismitglieder, die Passwort und alte E-Mail-Adresse verloren haben (Branch `claude/practice-member-recovery-20260726`). Ein-Befehl-Schnellstart für lokale Tests: `pnpm quickstart` (s. u.). Alle Prüfungen lokal und in CI grün: Typecheck, Lint, 115 Tests, 136 RLS-Proben, volle Playwright-Suite, Build, mobile Typecheck/Lint/16 Tests. Produktumfang: `docs/PRODUCT_SPEC.md` · Betreiberportal: `docs/PLATFORM_ADMIN_GUIDE.md` · Testmatrix: `docs/TEST_MATRIX.md` · Übergabe: `docs/AI_HANDOFF.md`.
...
| Betreiberportal | Zugangs-Wiederherstellung für Praxismitglieder (Passwort + alte E-Mail verloren) | 🧪 | 136 RLS-Proben + echter Playwright-Durchlauf (26.07.2026) | Nur Plattformadmin; hängt bestehende Mitgliedschaft auf neues Konto um, keine Praxisdaten gehen verloren; PR noch nicht gemergt |
