...
- [ ] Von Tom selbst live am Simulator bestätigt: Kapselform, Transparenz, Zieh-Geste, Icon-Wachstum, Animationsruhe.
- [ ] Vollständige Testmatrix (kleiner/großer Viewport, Dark Mode, Dynamic Type, Reduce Motion/Transparency, VoiceOver, Android-Fallback) – bisher nur Kernfunktion + Typecheck/Lint/Tests verifiziert, nicht die vollständige Zusatzliste.
- [ ] Commit/Push/PR – noch nicht angelegt, wartet auf Toms Bestätigung des visuellen Ergebnisses.
