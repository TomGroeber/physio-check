...
- [ ] GitHub CI: 3 von 4 Jobs grün; „Sicherheit"-Job scheitert an einer externen npm-Registry-Störung (`ERR_PNPM_AUDIT_BAD_RESPONSE`, bestätigt kein Befund dieses PRs, `main` war gestern mit identischer Toolchain grün) – Retry-Mechanismus ergänzt (D-099), Job muss erneut laufen, sobald sich die Registry erholt hat. Merge erst nach grüner CI und Toms Freigabe.
