...
> **Stand:** Phase E/F umgesetzt: interaktiver Praxiskalender, sichere Praxisverbindung, verordnete Sitzungen mit Historie sowie private Patientenakten. Produktumfang: `docs/PRODUCT_SPEC.md`.

## Aktueller Entwicklungsstand

- **Funktioniert:** freie Registrierung → Praxiscode, Praxiswechsel, Übungsdokumentation, Patientendetailseite und interaktiver Praxiskalender.
- **Kalender:** Termine anlegen, bearbeiten, stornieren und abschließen; Filter; Stornierung bleibt in der Historie.
- **Sitzungen:** Praxis hinterlegt Verordnungen und nachvollziehbare Anpassungen; abgeschlossene Termine rechnen atomar eine verfügbare Sitzung an; Patienten sehen ihren Stand.
- **Patientenakte:** Praxis lädt PDF/JPEG/PNG bis 20 MB in einen privaten Storage-Bucket; Öffnen nur über kurzlebige signierte URLs; Upload und Archivierung werden auditiert.
...
- **Lokal noch zu prüfen:** Migration `20260711230000_authorizations_and_patient_documents.sql`, Upload und kritische E2E-Abläufe mit Docker/Supabase.
- **Nächster Schritt:** lokale DB-/Storage-Prüfung, Cross-Practice-RLS-Tests und Absageanfragen annehmen/ablehnen.
- **GitHub:** `origin` zeigt auf `TomGroeber/physio-check`; jede abgeschlossene Etappe aktualisiert README und `docs/AI_HANDOFF.md`.
...
Die neueste Migration `20260711230000_authorizations_and_patient_documents.sql` ergänzt Verordnungen, Nutzungs-/Anpassungshistorie, atomare Anrechnung, private Dokumentmetadaten und den Bucket `patient-records`. Lokal genügt:
