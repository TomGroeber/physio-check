...
**Offen für die nächste Etappe:** Store-/Review-Paket zusammenstellen, Release-Candidate-Report, PR #4 auf mergefähig prüfen. Datenschutzerklärung braucht noch juristische Prüfung durch eine zuständige Person, sobald App-Identität feststeht. Phase 3 Rest (gehostetes Supabase-Projekt/Domain/Hosting), Phase 6 Rest (Screenshots), Phase 7–8 bleiben BLOCKIERT DURCH TOM/KONTO.
