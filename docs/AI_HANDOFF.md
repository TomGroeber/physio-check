...
**Offen für die nächste Etappe:** öffentliche Datenschutzerklärungsseite (Fließtext, rechtlich noch nicht final), Store-/Review-Paket zusammenstellen, Release-Candidate-Report, PR #4 auf mergefähig prüfen. Phase 3 Rest (gehostetes Supabase-Projekt/Domain/Hosting), Phase 6 Rest (Screenshots), Phase 7–8 bleiben BLOCKIERT DURCH TOM/KONTO.
